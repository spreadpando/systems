...
const Foot = styled.div`position:fixed;bottom:0;height:25px;width:100%;grid-column:1/5;background-color:black;z-index:2;margin-left:-10px;text-align:center;opacity:.7;`;
const SocialLink = styled.a`color:white;text-decoration:none;font-family: 'Cutive Mono';margin-left:10%;`;
